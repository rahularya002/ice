        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          {activeTab === 'details' && (
            <div className="space-y-8">
              ...
              {/* Submissions Section */}
              <div className="mt-8">
                <h5 className="text-lg font-semibold text-gray-900 mb-4">Submissions</h5>
              ...
              {/* Comments Section */}
              <div className="mt-8">
                <h5 className="text-lg font-semibold text-gray-900 mb-4">Comments</h5>
                {/* Add Comment Form */}
                <form onSubmit={handleCommentSubmit} className="border border-gray-200 rounded-lg p-4 mb-4">
